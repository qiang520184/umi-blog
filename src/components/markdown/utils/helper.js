...
import {BASIC_THEME_ID, MARKDOWN_THEME_ID, STYLE_LABELS, CODE_THEME_ID} from "./constant";
...
replaceStyle(MARKDOWN_THEME_ID, TEMPLATE.normal);

replaceStyle(CODE_THEME_ID, TEMPLATE.code.macAtomOneDark);

// replaceStyle(BASIC_THEME_ID, JSON.parse(window.localStorage.getItem(THEME_LIST)));
